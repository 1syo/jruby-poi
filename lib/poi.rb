...
# Java
require 'java'
require File.join(JRUBY_POI_LIB_PATH, 'poi-3.10-FINAL-20140208.jar')
require File.join(JRUBY_POI_LIB_PATH, 'poi-ooxml-3.10-FINAL-20140208.jar')
require File.join(JRUBY_POI_LIB_PATH, 'poi-ooxml-schemas-3.10-FINAL-20140208.jar')
require File.join(JRUBY_POI_LIB_PATH, 'poi-scratchpad-3.10-FINAL-20140208.jar')
